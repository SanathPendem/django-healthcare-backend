...
Generated with production-grade security defaults, JWT authentication,
and environment variable configuration via python-dotenv and dj-database-url.
"""
...
SECRET_KEY = os.getenv(
    'SECRET_KEY',
    'django-insecure-fallback-key-do-not-use-in-production-1234567890'
)
